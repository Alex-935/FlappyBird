...
public class FlappyBird  extends JPanel implements ActionListener, KeyListener{
    ...
    FlappyBird() {
        ...
        setFocusable(true);//ensures it takes the KeyEvent
        addKeyListener(this);//ensures 3 iverideen functions are checked
    ...
    public void placePipes() {
        int randomPipeY = (int) (pipeY - pipeHeight/4 - Math.random()*(pipeHeight/2));//rand between 0 and 256    between 1/4 and 3/4 height
